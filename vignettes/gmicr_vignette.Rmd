...
```{r additional packages, echo=TRUE, eval=FALSE}
...
```{r sample data, echo=TRUE, eval=FALSE}
...
```{r GO module annotations, echo=TRUE, eval=FALSE}
...
```{r GO enrichment, echo=TRUE, eval=FALSE}
...
set to -0.3.
```{r detecting inverse relationships, eval=FALSE, echo=TRUE}
...
```{r Visualizing network, eval=FALSE, echo=TRUE}
